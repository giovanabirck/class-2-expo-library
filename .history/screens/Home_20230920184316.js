            ...
            <View style={styles.container}>
                ...
                <View style={styles.chip_out}>
                    <View style={styles.chip_in}>
                        <Chip title="Solid Chip" containerStyle={{ marginVertical: 8 }} />
                        <Chip title="Disabled Chip" disabled containerStyle={{ marginVertical: 8 }}/>
                    </View>
                    <View style={styles.chip_in}>
                        <Chip title="Outlined Chip" type="outline" containerStyle={{ marginVertical: 8 }}/>
                        <Chip title="Outlined & Disabled" type="outline" disabled containerStyle={{ marginVertical: 15 }}/>
                    </View>
                </View>
